...
Pregnant Lords Expanded is a complete standalone mod. It must work with Bannerlord 1.5.3
when Affairs of Calradia/Friends With Benefits (AOC/FWB), DramaLord, and every other
